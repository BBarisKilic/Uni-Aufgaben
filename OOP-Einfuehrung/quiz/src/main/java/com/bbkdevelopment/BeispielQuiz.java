...
/**
 * BeispielQuiz ist eine Klasse, die ein Quiz mit vier Fragen erstellt und diese nacheinander
 * abfragt.
 */
public final class BeispielQuiz {

  /**
   * Main-Methode, die ein Quiz mit vier Fragen erstellt und diese nacheinander abfragt.
   */
  public static void main(String[] args) {
    final Quiz q = new Quiz(4);
  ...
  /**
   * Startet das Quiz und fragt die Fragen nacheinander ab.
   *
   * @param q Das Quiz, das abgefragt werden soll.
   */
  public static void start(Quiz q) {
    final Scanner s = new Scanner(System.in);
    for (int i = 0; i < q.liefereFragenAnzahl(); i++) {
      final Zahlenfrage f = q.liefereFrage(i);
    ...
    System.out.println("Insgesamt wurden " + q.berechneErreichtePunkte() + " / "
        + q.berechneMaximalMoeglichePunkte() + " Punkten erreicht.");
  }
}