import com.bbkdevelopment.Woerterraten;
...
public class WoerterratenTest extends TestCase {
  ...
  public void testeEinfachesVorkommenAnfang() {
    ...
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt", "H***",
  ...
  public void testeEinfachesVorkommenMitte() {
    ...
    init(w);
    wr.aktualisiereLoesung(c);
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt", "*A**",
        wr.erratenesWort.toString());
  }
  ...
  public void testeEinfachesVorkommenEnde() {
    ...
    init(w);
    wr.aktualisiereLoesung(c);
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt", "***S",
        wr.erratenesWort.toString());
  }
  ...
  public void testeMehrfachesVorkommen() {
    ...
    init(w);
    wr.aktualisiereLoesung(c);
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt", "T**T",
        wr.erratenesWort.toString());
    wr = new Woerterraten();
    ...
    init(w);
    wr.aktualisiereLoesung(c);
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt",
        "**T******T*****T****T****T***", wr.erratenesWort.toString());
  }
  ...
  public void testeNurGleiche() {
    ...
    wr.aktualisiereLoesung(c);
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt",
        "LLLLLLLL", wr.erratenesWort.toString());
  }
  ...
  public void testeAlleBuchstabenEinfach() {
    for (char c = 'A'; c <= 'Z'; c++) {
      ...
      init(w);
      wr.aktualisiereLoesung(c);
      assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt", "" + c,
          wr.erratenesWort.toString());
    }
  }
  ...
  public void testeAlleBuchstabenMehrfach() {
    for (char c = 'A'; c <= 'Z'; c++) {
      ...
      wr.aktualisiereLoesung(c);
      assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt",
          "" + c + c + c, wr.erratenesWort.toString());
    }
  }
  ...
  public void testeSehrLangesWort() {
    ...
    init(w);
    wr.aktualisiereLoesung(c);
    assertEquals("Der Buchstabe " + c + " wurde im Wort " + w + " nicht korrekt ersetzt", loesung,
        wr.erratenesWort.toString());
  }
  ...
  public void testeMehrmaligenAufruf() {
    ...
    assertEquals("Das komplette Erraten des Wortes " + w + " hat nicht funktioniert", w,
        wr.erratenesWort.toString());
  }
}